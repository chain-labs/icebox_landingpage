						...
						<div className="frame-6">
							...
							<div className="frame-9">
								...
								<p className="text-wrapper-5">
									Lenders can earn yield by offering collateralized loans.
								</p>
							</div>
						</div>
							...
							<div className="frame-11">
								<div className="frame-12">
									...
									<p className="text-wrapper-7">
										Escrow funcitonality mangaged by combination of smart
										contracts and multisig wallets
									</p>
								</div>
							...
							<div className="frame-11">
								<div className="frame-16">
									...
									<p className="text-wrapper-11">
										Sub-copy: Get up to 2 BTC with just three clicks
									</p>
								</div>
								<img
									className="frame-17"
									alt="Frame"
									src="/img/frame-1321315251.svg"
								/>
							</div>
						</div>
					</div>
					...
					<div className="frame-22">
						<div className="frame-23">
							<img
								...
								alt="Rectangle"
								src="/img/rectangle-34624160-2.png"
							/>
						...
						<div className="frame-27">
							<div className="overlap-2">
								<p className="text-wrapper-22">
									See all collections and borrow against them.
								</p>
